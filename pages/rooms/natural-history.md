...
<section class="atrium-page collection-room-natural-history">
  ...
  <div class="house-scene">
    <div class="house-backdrop natural-history-hall">
      ...
      <a class="natural-side-sign natural-side-sign-right" href="{{ '/pages/rooms/art.html' | relative_url }}" aria-label="Go to the Art room from the right side">
        <span class="natural-side-sign-label">Art →</span>
      </a>
