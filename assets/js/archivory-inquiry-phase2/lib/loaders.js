...
export async function loadSystemPrompt() {
  const files = ["prompts/identity.md","prompts/behavioral-constitution.md","prompts/classification.md","prompts/historical-method.md","prompts/questioning-strategy.md","prompts/tone.md","prompts/grounding.md"];
